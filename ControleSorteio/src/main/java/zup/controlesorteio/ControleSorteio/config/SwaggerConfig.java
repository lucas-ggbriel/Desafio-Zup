package zup.controlesorteio.ControleSorteio.config;
...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Gerenciador de sorteio").description("API de gerenciamento de sorteio").version("1.0")
